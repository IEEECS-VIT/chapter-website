...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      mq.removeEventListener ? mq.removeEventListener("change", handleMQ) : mq.removeListener(handleMQ);
  ...
  const MobileLayout = (
    ...
    >
      <div className="relative w-full h-[172px]">
        ...
        >
          <path d="M0 -15H440V157C339.769 91.4234 131.028 79.2404 0 157V-15Z" fill="black" />
        </svg>
      </div>
      ...
      >
        <div style={{ width: "100%", height: "100%", position: "relative" }}>
          <SketchfabModel
            ...
            showCredits={false}
            autoLoad={true}
            iframeProps={{ style: { position: "absolute", top: 0, left: 0, width: "100%", height: "100%" } }}
          />
        </div>
      </div>
      ...
      >
        ...
        >
          We, here at IEEECS, nurture the coders and leaders of tomorrow. We empower and support new ideas giving
          them a platform to shine.IEEECS has been a home to great ideas capable of bringing a better future for
          all.
        </p>
      </div>
      ...
      >
        <button
          ...
          style={{
            ...
            borderColor: "#DDB373",
            background: "linear-gradient(90deg, #D4A02A 0%, #AD4C01 50%, #9B4102 100%)",
            color: "#4B3200",
            fontFamily: "Gloock, serif",
            fontSize: `${8.4 * s}px`,
        ...
        >
          <span style={{ color: "#4B3200", fontFamily: "Gloock, serif" }}>Submit</span>
        </button>
      </div>
      ...
      >
        <span style={{ fontSize: `${7.39 * s}px`, letterSpacing: `${0.517 * s}px` }}>PRIVACY POLICY</span>
        <span style={{ fontSize: `${7.39 * s}px`, letterSpacing: `${0.517 * s}px` }}>DISCLAMER</span>
        <span style={{ fontSize: `${7.39 * s}px`, letterSpacing: `${0.517 * s}px` }}>TERMS AND CONDITIONS</span>
        <span style={{ fontSize: `${7.39 * s}px`, letterSpacing: `${0.517 * s}px` }}>SEE WHAT WE'RE UP TO</span>
      </div>

      <div className="absolute left-0" style={{ top: socialsTop, width: "100%", height: Math.round(15 * s) }}>
        <div
          style={{
    ...
    >
      ...
      <main className="z-10 w-[90%] max-w-[90vw] mt-40 grid grid-cols-1 lg:grid-cols-3 gap-[5%] px-[5%] mx-auto flex-1 place-content-center">
        ...
        <div className="flex items-center justify-center order-1 lg:order-2">
          <div style={{ width: "90%", maxWidth: "20vw", aspectRatio: "1 / 1", display: "block" }}>
            <SketchfabModel
              modelId="1eecbfe0ae134b4886e3fff4198eb6c3"
              ratio={1}
              width="100%"
        ...
        <div className="flex flex-col order-2">
          <h2 className="text-[clamp(1rem,1.4vw,1.6rem)] mt-[5%] mb-[2%]" style={{ color: "#4B3200", fontFamily: "Gloock, serif" }}>
            Get in Touch
          </h2>
          <p className="text-[clamp(1.45rem,1.1vw,1.3rem)]" style={{ color: "#4B3200", fontFamily: "Gloock, serif" }}>
            IEEECS@vit.ac.in
          </p>
          <p className="text-[clamp(1.45rem,1.1vw,1.3rem)] mb-[20%]" style={{ color: "#4B3200", fontFamily: "Gloock, serif" }}>
            +91 9380302937
          </p>
          <p className="text-[clamp(1.45rem,1.1vw,1.3rem)] leading-relaxed mt-[4%] max-w-[100%]" style={{ color: "#4B3200", fontFamily: "Gloock, serif" }}>
            We, here at IEEE CS, nurture the coders and leaders of tomorrow. We empower and support new ideas giving them a platform to shine. IEEE CS has been a home to great ideas capable of bringing a better future for all.
          </p>
        </div>
      </main>

      <footer className="w-full relative z-10 flex flex-col items-center mt-auto pb-[3%]" style={{ color: "#4B3200", fontFamily: "Gloock, serif" }}>
        <div className="w-full max-w-[100%] flex flex-col md:flex-row items-center justify-center gap-6 md:gap-64">
          <div className="flex items-center gap-6 md:gap-8">
            <a href="#" className="hover:underline whitespace-nowrap font-semibold" style={{ color: "#4B3200", fontSize: "clamp(0.95rem,1rem,1.1rem)" }}>
              PRIVACY POLICY
            </a>
            <a href="#" className="hover:underline whitespace-nowrap font-semibold" style={{ color: "#4B3200", fontSize: "clamp(0.95rem,1rem,1.1rem)" }}>
              DISCLAIMER
            ...
            <span className="whitespace-nowrap font-semibold" style={{ color: "#4B3200", fontSize: "clamp(0.95rem,1rem,1.1rem)" }}>
